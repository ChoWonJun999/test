            ...
            <div class="modal-content">
                ...
                <div class="modal-body basic-form">
                	<form id="calendarForm">
                		<input type="hidden" name="bApcoKey" id="bApcoKey"/>
                    	...
                    	<div class="form-group row">
		                    <label class="col-sm-3 col-form-label">객실</label>
		                    <div class="col-sm-9">
	                    ...
	                    <div class="form-group row">
		                    ...
		                    <div class="col-sm-9">
		                    	<textarea class="form-control h-150px" rows="6" id="bApcoEtc" name="bApcoEtc"></textarea>
		                    </div>
	                    </div>
                    </form>
                </div>
